...
'sdfopen dt_global_allsat_msla_h_mwgs_month.nc'
'sdfopen dt_global_allsat_msla_h_ywgs_year_mwgs_month.nc'
...
*      'set map 1 1 8'
    if ( anomaly = 1 ) 
      case_name='ssh_anomaly_'wgs_year
    else
      case_name='ssh_mwgs_month_'
    endif
*      'set mpdset hires'
'set map 1 1 5'
'set mpdset hires'
