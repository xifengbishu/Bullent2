...
'd mag(ave(uwnd,t=793,t=804),ave(vwnd.2,t=793,t=804))'
*'set grid on 2 1'
'set gxout vector'
'set cthick 5'
*'set map 'map_color
...
*         'd 'u_part' ; 'v_part''
'd ave(uwnd,t=793,t=804);ave(vwnd.2,t=793,t=804)'
...
*        'draw string 'str_x' 'y_v - str_y' wgs_date'
...
* --- imagick software needed
  '! convert -density 1200 -trim -resize 25% 'outname'.eps tmp.jpg'
  '! convert -density 600  -trim tmp.jpg 'outname'.jpg'
...
* --- 7: white and red 
  if( color_num = 7 )
    ...
    _ncolor  = ' 0 36  35 34 33  32 31  30 29  28  27 26  25  24 23 22 '
    _nheight = ' 1 1.5 2  2.5 3  3.5 4  4.5 5  5.5 6  6.5 7  7.5 8 ' 
...
_nheight = ' 1 1.5   2 2.5 3  3.5 4  4.5 5  5.5 6  6.5 7 7.5 ' 
*_nheight = ' 0.4 0.6  0.8  1   1.2  1.4  1.6  1.8  2  2.2 2.4' 
  endif
  if( color_num = 125 ) 
'set rgb 21 0 77 137'
