...
# === sla anomaly for 2010 - 2009 
  ...
  mkdir temp
  rm -f temp/*
  rm -f year_ave_nrt_global_allsat_msla_h_${year}.nc cha_year_ave_nrt_global_allsat_msla_h_y${year}-*.nc
  
  ln -s $mete_root/nrt_global_allsat_msla_h_${year}*.nc ./temp
  cd temp
  set num = 1
  ...
  cd ..
  mv temp/year_ave_nrt_global_allsat_msla_h_${year}.nc ./
