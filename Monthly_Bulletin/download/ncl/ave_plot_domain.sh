...
#
 ...
 do
   ...
   sed -e 's/wgs_t1/'${t1}'/' -e 's/wgs_t2/'${t2}'/' ave_oscar2.ncl > ave_oscar2_OK.ncl
   ncl ave_oscar2_OK.ncl
   convert -density 600 -trim 2oscar.eps ave_oscar_${month}.jpg 
   mv 2oscar.eps ave_oscar_${month}.eps
