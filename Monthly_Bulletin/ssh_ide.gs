...
* --- ctl name (numbers = y_num)
  anomaly = wgs_anomaly
  if ( anomaly = 1 ) 
    'sdfopen ave_ssh/cha_climate_y2014_mwgs_tbeg.nc'
  else
    'sdfopen ave_ssh/ave_nrt_global_allsat_msla_h_2014wgs_tbeg.nc'
  endif
...
*      'set map 1 1 8'
    if ( anomaly = 1 ) 
      case_name='ssh_anomaly_'wgs_tbeg
    else
      case_name='ssh_month_'wgs_tbeg
    endif
*      'set mpdset hires'
'set map 1 1 5'
'set mpdset hires'
